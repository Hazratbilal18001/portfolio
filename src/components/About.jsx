...
const About = () => {
    return (
        <div id="about" className="flex  w-full gap-6 pt-30 px-20 bg-[#ECF3F1]">
            {/* Left Side - Card */}
            < div className="w-[30%] h-full bg-white shadow-lg rounded-xl flex flex-col items-center p-6" >
                {/* Profile Image */}
                <div className="pt-3">
                    < div className=" rounded-full border-2  border-dashed border-[#448C74] overflow-hidden" >
                        <img src="./images/CEO1.jpeg" alt="Profile" className="w-60 object-cover" />
                    </div >
                </div>
                {/* Name & Description */}
                ...
                <div className="flex gap-4 mt-6 text-xl">
                    <a href="#" className="border border-[#EEEEEE] rounded-lg p-2 text-[#444444] hover:text-[#448C74] ">
                        <FaFacebook />
                    </a>
                    <a href="#" className="border border-[#EEEEEE] rounded-lg p-2 text-[#444444]  hover:text-[#448C74]">
                        <FaTwitter />
            ...
            < div className="w-[70%] h-screen flex flex-col gap-6" >
                ...
                < div className="bg-white shadow-lg rounded-xl p-8  h-[70vh] flex flex-col justify-between" >
                    ...
                    <h1 className="text-4xl font-bold w-[75%]">
                ...
                {/* Scrolling Text */}
                < div className="w-full overflow-hidden whitespace-nowrap text-xl font-semibold text-gray-700" >
